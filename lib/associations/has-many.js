...
HasMany.prototype.injectGetter = function(obj) {
  ...
  obj[(obj[this.accessors.get] ? '_' : '') + this.accessors.get] = function(options) {
  ...
  obj[(obj[this.accessors.hasSingle] ? '_' : '') + this.accessors.hasSingle] = obj[(obj[this.accessors.hasAll] ? '_' : '') + this.accessors.hasAll] = function(instances, options) {
    var where = {};
...
HasMany.prototype.injectSetter = function(obj) {
  ...
  obj[(obj[this.accessors.set] ? '_' : '') + this.accessors.set] = function(newAssociatedObjects, additionalAttributes) {
  ...
  obj[(obj[this.accessors.addMultiple] ? '_' : '') + this.accessors.addMultiple] = obj[(obj[this.accessors.add] ? '_' : '') + this.accessors.add] = function(newInstance, options) {
  ...
  obj[(obj[this.accessors.remove] ? '_' : '') + this.accessors.remove] = function(oldAssociatedObject, options) {
    var instance = this;
    return instance[association.accessors.get]({
      scope: false
  ...
  obj[(obj[this.accessors.removeMultiple] ? '_' : '') + this.accessors.removeMultiple] = function(oldAssociatedObjects, options) {
    var instance = this;
    return instance[association.accessors.get]({
      scope: false
    }, options).then(function(currentAssociatedObjects) {
...
HasMany.prototype.injectCreator = function(obj) {
  ...
  obj[(obj[this.accessors.create] ? '_' : '') + this.accessors.create] = function(values, options) {
    var instance = this;
    options = options || {};
