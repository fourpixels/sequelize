...
BelongsTo.prototype.injectGetter = function(instancePrototype) {
  ...
  instancePrototype[(instancePrototype[this.accessors.get] ? '_' : '') + this.accessors.get] = function(options) {
    var where = {};
...
BelongsTo.prototype.injectSetter = function(instancePrototype) {
  ...
  instancePrototype[(instancePrototype[this.accessors.set] ? '_' : '') + this.accessors.set] = function(associatedInstance, options) {
    options = options || {};
...
BelongsTo.prototype.injectCreator = function(instancePrototype) {
  ...
  instancePrototype[(instancePrototype[this.accessors.create] ? '_' : '') + this.accessors.create] = function(values, fieldsOrOptions) {
    var instance = this
      , options = {};
