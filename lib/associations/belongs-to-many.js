...
module.exports = (function() {
  ...
  BelongsToMany.prototype.injectSetter = function(obj) {
    ...
    obj[(obj[this.accessors.set] ? '_' : '') + this.accessors.set] = function(newAssociatedObjects, options) {
      options = options || {};
      var instance = this;
    ...
    obj[(obj[this.accessors.addMultiple] ? '_' : '') + this.accessors.addMultiple] = obj[(obj[this.accessors.add] ? '_' : '') + this.accessors.add] = function(newInstance, additionalAttributes) {
    ...
    obj[(obj[this.accessors.removeMultiple] ? '_' : '') + this.accessors.removeMultiple] = obj[(obj[this.accessors.remove] ? '_' : '') + this.accessors.remove] = function(oldAssociatedObject, options) {
      options = options || {};
      options.remove = true;
